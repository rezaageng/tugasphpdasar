           ...
           <div class="button2">
               <ul>
                    <?php foreach ($anime as $an): ?>
			            <li><a class="anime" href="array2.php?nama=<?php echo $an["nama"]; ?>&studio=<?php echo $an["studio"]; ?>&tayang=<?php echo $an["tayang"]; ?>&eps=<?php echo $an["eps"]; ?>&img=<?php echo $an["img"]; ?>&gaman=<?php echo $an["gaman"]; ?>"><?php echo $an["nama"]; ?></a></li>
		            <?php endforeach ?>
               </ul>
           </div>
       </div>
